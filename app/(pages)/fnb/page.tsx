  ...
  return (
    <>
      ...
      <section className="pt-[120px] pb-xl px-8 fnb-pattern">
        <div className="max-w-7xl mx-auto text-center md:text-left">
          <span className="font-label-caps text-label-caps text-primary-container bg-primary-fixed/30 px-sm py-xs rounded-full inline-block mb-md tracking-widest">
            F&amp;B BRAND &amp; REVENUE SYSTEMS
          </span>
          <h1 className="font-h1 text-[60px] leading-[1.05] text-primary mb-lg max-w-3xl tracking-tight">
            Your Restaurant, Built to Grow.
          </h1>
          <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl mb-lg">
            We build brand systems for restaurants, cafés, and cloud kitchens that drive repeat visits, optimize menu margins, and automate local discoverability. Ensure your brand brings in business every day.
          </p>
          <button className="bg-lime text-on-surface px-lg py-sm rounded-lg font-h3 text-body-md font-bold hover:translate-y-[-2px] transition-transform duration-200 shadow-sm">
            Enquire About F&amp;B Growth Systems →
          </button>
        </div>
      </section>
      ...
      <section className="py-xl px-8 bg-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-xl items-center">
          ...
          <div className="order-1 md:order-2">
            <span className="font-label-caps text-label-caps text-secondary font-bold mb-xs block tracking-widest">01 F&B Identity &amp; Margin Architecture</span>
            <h2 className="font-h2 text-h2 text-primary mb-md tracking-tight">Signature Revenue Systems</h2>
            <ul className="space-y-sm mb-lg">
              <li className="flex items-center gap-xs font-body-md text-on-surface">
                <span className="material-symbols-outlined text-secondary" style={{ fontVariationSettings: "'FILL' 1" }}>check_circle</span>
                Custom Logo Design &amp; Brand Systems
              </li>
              <li className="flex items-center gap-xs font-body-md text-on-surface">
                <span className="material-symbols-outlined text-secondary" style={{ fontVariationSettings: "'FILL' 1" }}>check_circle</span>
                Margin-Optimized Digital &amp; Physical Menus
              </li>
              <li className="flex items-center gap-xs font-body-md text-on-surface">
                <span className="material-symbols-outlined text-secondary" style={{ fontVariationSettings: "'FILL' 1" }}>check_circle</span>
                Packaging &amp; High-Conversion Collateral
              </li>
            </ul>
            <div className="p-md bg-surface-container-low rounded-lg inline-block tinted-border">
              <p className="font-h3 text-primary">Enquire About F&amp;B Identity</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-xl px-8 bg-bg">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-xl items-center">
          <div>
            <span className="font-label-caps text-label-caps text-secondary font-bold mb-xs block tracking-widest">02 Autopilot Content Systems</span>
            <h2 className="font-h2 text-h2 text-primary mb-md tracking-tight">Visual Storytelling on Repeat</h2>
            <p className="font-body-md text-on-surface-variant mb-lg">
              Stop worrying about what to post. Our AI-enhanced content engines generate aesthetic food imagery and engaging video assets that keep your tables full.
            </p>
            <div className="p-md bg-white rounded-lg inline-block tinted-border">
              <p className="font-h3 text-primary">Enquire for Autopilot Systems</p>
            </div>
          </div>
          <div>
      ...
      <section className="py-xl px-8 bg-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-xl items-center">
          ...
          <div className="order-1 md:order-2">
            <span className="font-label-caps text-label-caps text-secondary font-bold mb-xs block tracking-widest">03 Local Visibility &amp; Search Dominance</span>
            <h2 className="font-h2 text-h2 text-primary mb-md tracking-tight">Dominate the Local Map</h2>
            <p className="font-body-md text-on-surface-variant mb-lg">
              We optimize your profiles for local search and AI discovery. Whether customers use Zomato or Google local AI recommendations, we ensure your restaurant is the first choice.
            </p>
            <div className="p-md bg-surface-container-low rounded-lg inline-block tinted-border">
              <p className="font-h3 text-primary">Enquire for Visibility Management</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto bg-primary-container rounded-[32px] p-xl text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-sm bg-white/10 px-md py-xs rounded-full text-on-primary-container font-label-caps mb-lg border border-white/20 tracking-widest">
              ...
              Your brand shouldn&apos;t just look good — it should bring in business.
            </div>
            <h2 className="font-h2 text-h1 text-white mb-lg tracking-tight">Ready to scale your F&amp;B demand?</h2>
